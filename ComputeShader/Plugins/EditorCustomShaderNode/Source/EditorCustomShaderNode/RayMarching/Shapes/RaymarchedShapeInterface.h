...
class URaymarchedShapeProperties;
...
public:	
	virtual ARaymarchedPhysicsShape* CreateShape(ARaymarchMaterialBuilder* Builder, UMaterial* Material, const int idx)
	...
	virtual void HookUpOtherShading(UCustomFileMaterialExpression* Shading) 
		PURE_VIRTUAL(IRaymarchedShapeInterface::HookUpOtherShading,);
	...
	virtual UCustomFileMaterialExpression* CreateShadingNode(UMaterial* Material, const FShapeShaderProperties shape,
		...
		PURE_VIRTUAL(IRaymarchedShapeInterface::CreateShadingNode, return nullptr;);
