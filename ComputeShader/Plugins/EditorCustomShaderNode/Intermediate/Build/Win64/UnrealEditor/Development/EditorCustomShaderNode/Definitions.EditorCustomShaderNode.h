#undef EDITORCUSTOMSHADERNODE_API
...
#define UE_PROJECT_NAME ComputeShader
#define UE_TARGET_NAME ComputeShaderEditor
...
#define EDITORCUSTOMSHADERNODE_API DLLEXPORT
